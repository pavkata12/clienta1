...
class TimerOverlay(QWidget):
    def __init__(self):
        ...
        self.setWindowTitle('🏎️ Sim Racing Academy - Session Timer')
        ...
        self.time_label.setStyleSheet('''
            background: qlineargradient(x1:0, y1:0, x2:1, y2:1,
                stop:0 rgba(0,0,0,0.9), stop:1 rgba(0,26,26,0.9));
            color: #00A19C; 
            font-size: 60px; 
            border-radius: 24px; 
            padding: 40px 20px; 
            font-weight: bold;
            border: 3px solid rgba(0,161,156,0.5);
        ''')
        ...
        self.minimize_btn.setStyleSheet(self.get_button_style('#00A19C'))
        
        self.end_btn = QPushButton('🛑 End Session', self)
        self.end_btn.setStyleSheet(self.get_button_style('#f97316'))
...
class LockScreen(QWidget):
    def __init__(self):
        ...
        # Logo
        logo_label = QLabel('🏎️ Sim Racing Academy', self)
        ...
        self.login_button.setStyleSheet('''
            QPushButton {
                ...
                font-weight: bold;
                padding: 0px;
                border: 3px solid rgba(0, 161, 156, 0.8);
                border-radius: 16px;
                margin-top: 30px;
                text-align: center;
            }
...
class LoginDialog(QDialog):
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('🏎️ Sim Racing Academy - Login')
        ...
        self.setStyleSheet('''
            QDialog {
                ...
                border-radius: 16px;
                border: 4px solid rgba(0, 161, 156, 0.8);
                margin: 0px;
                padding: 20px;
            }
            QLabel {
        ...
        # Header
        header_label = QLabel('🏎️ Welcome to Sim Racing Academy')
    ...
    def install(self, lock_mode=True):
        ...
        try:
                    ...
                    if nCode == 0:
                        ...
                        if wParam in (WM_KEYDOWN, WM_SYSKEYDOWN):
                            ...
                            # Session mode: Only block dangerous combinations
                                ...
                                # Gaming mode: Allow Windows keys for Alt+Tab and other shortcuts
                                # Removed Windows key blocking to allow normal gaming shortcuts
                                
                                # Block Ctrl+Shift+Esc specifically (Task Manager)
                                if (vk_code == 0x1B and 
            ...
            if lock_mode:
                ...
                logger.info("   - Windows keys ALLOWED (for Alt+Tab and gaming shortcuts)")
...
class NetCafeClient:
    def __init__(self):
        ...
        logger.info(f"Sim Racing Academy initialized. Computer ID: {self.computer_id}")
    ...
    def _init_tray(self):
        try:
            ...
            self.tray.setToolTip('🏎️ Sim Racing Academy - Gaming Client')
    ...
    def run(self):
        logger.info("🏎️ Starting Sim Racing Academy (BACKGROUND MODE)")
